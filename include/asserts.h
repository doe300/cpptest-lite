...
#define TEST_FAIL(msg)                                                                                                 \
  {                                                                                                                    \
    testFailed(Test::Assertion(__FILE__, __LINE__, msg));                                                              \
...
#define TEST_ASSERT(condition)                                                                                         \
  {                                                                                                                    \
    if (!(condition)) {                                                                                                \
      testFailed(                                                                                                      \
          Test::Assertion(__FILE__, __LINE__, std::string("Assertion '") + #condition + std::string("' failed"), "")); \
      if (!continueAfterFailure())                                                                                     \
        return;                                                                                                        \
    } else                                                                                                             \
...
#define TEST_ASSERT_MSG(condition, msg)                                                                                \
  {                                                                                                                    \
    if (!(condition)) {                                                                                                \
      testFailed(Test::Assertion(                                                                                      \
          __FILE__, __LINE__, std::string("Assertion '") + #condition + std::string("' failed"), msg));                \
      if (!continueAfterFailure())                                                                                     \
        return;                                                                                                        \
    } else                                                                                                             \
      testSucceeded(Test::Assertion(__FILE__, __LINE__));                                                              \
...
#define TEST_THROWS_MSG(expression, except, msg)                                                                       \
  {                                                                                                                    \
    try {                                                                                                              \
      ...
      /*If we get here, no exception was thrown*/                                                                      \
      testFailed(Test::Assertion(__FILE__, __LINE__,                                                                   \
          std::string("Expected exception of type '") + #except + std::string("' was not thrown!"), msg));             \
      if (!continueAfterFailure())                                                                                     \
        return;                                                                                                        \
    } catch (except &) {                                                                                               \
      testSucceeded(Test::Assertion(__FILE__, __LINE__));                                                              \
      ...
      /*If we get here, wrong exception was thrown*/                                                                   \
      testFailed(Test::Assertion(__FILE__, __LINE__, std::string("Wrong Exception was thrown: ") + ex.what(), msg));   \
      if (!continueAfterFailure())                                                                                     \
        return;                                                                                                        \
    } catch (...) {                                                                                                    \
      /* Any other type than an exception was thrown*/                                                                 \
      testFailed(Test::Assertion(__FILE__, __LINE__,                                                                   \
          std::string("A non-exception-type was thrown, expected exception of type: ") + #except, msg));               \
      if (!continueAfterFailure())                                                                                     \
        return;                                                                                                        \
    }                                                                                                                  \
  }
...
#define TEST_THROWS_ANYTHING_MSG(expression, msg)                                                                      \
  {                                                                                                                    \
    try {                                                                                                              \
      ...
      /* Any other type than an exception was thrown*/                                                                 \
      testFailed(Test::Assertion(__FILE__, __LINE__, "A non-exception-type was thrown!", msg));                        \
      if (!continueAfterFailure())                                                                                     \
        return;                                                                                                        \
    }                                                                                                                  \
  }
...
#define TEST_THROWS_NOTHING_MSG(expression, msg)                                                                       \
  {                                                                                                                    \
    try {                                                                                                              \
      ...
      testFailed(Test::Assertion(__FILE__, __LINE__, std::string("Exception thrown: ") + ex.what(), msg));             \
      if (!continueAfterFailure())                                                                                     \
        return;                                                                                                        \
    } catch (...) {                                                                                                    \
      /* Any other type than an exception was thrown*/                                                                 \
...
#define TEST_PREDICATE(predicate, value)                                                                               \
  {                                                                                                                    \
    if (!predicate(value)) {                                                                                           \
      testFailed(Test::Assertion(__FILE__, __LINE__,                                                                   \
          std::string("Value '") + Test::Formats::to_string(value) + std::string("' did not match the predicate: ") +  \
              #predicate,                                                                                              \
          ""));                                                                                                        \
      if (!continueAfterFailure())                                                                                     \
        return;                                                                                                        \
...
#define TEST_BIPREDICATE(bipredicate, value0, value1)                                                                  \
  {                                                                                                                    \
    if (!bipredicate(value0, value1)) {                                                                                \
      testFailed(Test::Assertion(__FILE__, __LINE__,                                                                   \
          std::string("Values '") + Test::Formats::to_string(value0) + "' and '" + Test::Formats::to_string(value1) +  \
              std::string("' did not match the bi-predicate: ") + #bipredicate,                                        \
          ""));                                                                                                        \
      if (!continueAfterFailure())                                                                                     \
        return;                                                                                                        \
    } else                                                                                                             \
...
#define TEST_ABORT(msg)                                                                                                \
  {                                                                                                                    \
    testFailed(Test::Assertion(__FILE__, __LINE__, "Test-method aborted!", msg));                                      \
    return;                                                                                                            \
  }
#define TEST_STRING_EQUALS(expected, value)                                                                            \
  {                                                                                                                    \
    if (std::string(expected) != (value)) {                                                                            \
      testFailed(Test::Assertion(__FILE__, __LINE__,                                                                   \
          std::string("Got \"") + std::string(value) + std::string("\", expected \"") + std::string(expected) +        \
              std::string("\""),                                                                                       \
          ""));                                                                                                        \
      if (!continueAfterFailure())                                                                                     \
        return;                                                                                                        \
...
#define TEST_ASSERT_NOT_EQUALS(expected, value)                                                                        \
  {                                                                                                                    \
    if (Test::Comparisons::isSame(expected, value)) {                                                                  \
      testFailed(Test::Assertion(__FILE__, __LINE__,                                                                   \
          std::string("Expected ") + Test::Formats::to_string(value) + std::string(" to differ from ") +               \
              Test::Formats::to_string(expected),                                                                      \
          ""));                                                                                                        \
      if (!continueAfterFailure())                                                                                     \
        return;                                                                                                        \
...
#define TEST_ASSERT_FALSE(condition)                                                                                   \
  {                                                                                                                    \
    if ((condition)) {                                                                                                 \
      testFailed(Test::Assertion(                                                                                      \
          __FILE__, __LINE__, std::string("Assertion '") + #condition + std::string("' passed unexpectedly"), ""));    \
      if (!continueAfterFailure())                                                                                     \
        return;                                                                                                        \
    } else                                                                                                             \
      testSucceeded(Test::Assertion(__FILE__, __LINE__));                                                              \
...
#define TEST_ASSERT_FALSE_MSG(condition, msg)                                                                          \
  {                                                                                                                    \
    if ((condition)) {                                                                                                 \
      testFailed(Test::Assertion(                                                                                      \
          __FILE__, __LINE__, std::string("Assertion '") + #condition + std::string("' passed unexpectedly"), msg));   \
      if (!continueAfterFailure())                                                                                     \
        return;                                                                                                        \
    } else                                                                                                             \
      testSucceeded(Test::Assertion(__FILE__, __LINE__));                                                              \
