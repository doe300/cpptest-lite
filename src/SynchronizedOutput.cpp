...
void SynchronizedOutput::initializeTestMethod(
...
void SynchronizedOutput::finishTestMethod(
...
void SynchronizedOutput::printException(const std::string &suiteName, const std::string &methodName,
