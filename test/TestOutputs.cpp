...
TestOutputs::TestOutputs()
    : Test::Suite("TestOutputs"), textOutput(new TextOutput(TextOutput::Verbose)),
...
TestWithOutput::TestWithOutput() : Suite("TestWithOutput") {
  ...
  TEST_ADD_WITH_STRING_LITERAL(
      TestWithOutput::anotherTestMethod, const_cast<char *>(std::string("Test method 1").data()));
  TEST_ADD_WITH_STRING_LITERAL(
      TestWithOutput::anotherTestMethod, const_cast<char *>(std::string("Test method 2").data()));
